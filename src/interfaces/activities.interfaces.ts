...
import { activitiesCreateSchema, activitiesReadSchema, activitiesSchema } from "../schemas/activities.schemas";
...
export type ActivitiesReturn = z.infer<typeof activitiesSchema>;
